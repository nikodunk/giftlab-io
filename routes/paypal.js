  ...
  router.post('/execute-payment/:sku/:amount/', function(req, res) {
    ...
    request.post(PAYPAL_API + '/v1/payments/payment/' + paymentID +
      ...
      function(err, response)
      {
        ...
        client.query(`INSERT INTO orders VALUES ('`+response.body.id+`','`+response.body.payer.payer_info.email+`',`+response.body.transactions[0].amount.total+`,'`+response.body.transactions[0].item_list.items[0].sku+`');`)
